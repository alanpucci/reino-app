...
const ReportExpensesDetail = ({ navigation, route }) => {
    ...
    const fetchUserData = async () => {
        const { data } = await axios(`https://reino-casero-api.vercel.app/api/expenses?initialDate=${initialDate.toISOString()}&toDate=${toDate.toISOString()}`);
        setSales(data);
    }
...
export default ReportExpensesDetail
